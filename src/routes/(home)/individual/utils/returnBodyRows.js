import { genderIndex } from '$lib/components/common/data';
import buildTeeArray from '$lib/components/common/utils/buildTeeArray.js';
import setRatingSlopePar from '$lib/components/common/utils/setRatingSlopePar.js';
	...
	function compute(aTee) {
		...
		for (i = 0; i < 6; i++) {
			...
			if (teeIndex === -1) {
				...
				const [rating, slope, par] = setRatingSlopePar(ratings, slopes, pars, i, teeIndex, gender);
