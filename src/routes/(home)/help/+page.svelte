...
<div id='help'>
  ...
  <details id='details'>
    ...
    <ul>
      <li>
        <a on:click={handleClick} href='#table'>
          Table of Players and Groups
        </a>
        <ul>
          <li>
            <a on:click={handleClick} href='#edit'>
              Editing Your Players and Groups
            </a>
          </li>
          <li>
            <a on:click={handleClick} href='#addplayer'>
              Adding a Player
            </a>
          </li>
          <li>
            <a on:click={handleClick} href='#addgroup'>
              Adding a Group
            </a>
          </li>
          <li>
            <a on:click={handleClick} href='#lookup'>
              Finding the GHIN Number of a New Player
            </a>
          </li>
          <li>
            <a on:click={handleClick} href='#addguest'>
              Adding a Guest
            </a>
          </li>
          <li>
            <a on:click={handleClick} href='#addcanadianguest'>
      ...
      <li>
        <a on:click={handleClick} href='#lineups'>
          Lineups
        </a>
        <ul>
          <li>
            <a on:click={handleClick} href='#create'>
              Creating a Lineup
            </a>
          </li>
          <li>
            <a on:click={handleClick} href='#changetees'>
              Changing the Tees Selected
            </a>
          </li>
          <li>
            <a on:click={handleClick} href='#manageplayers'>
              Managing the Players in Your Lineup
            </a>
          </li>
          <li>
            <a on:click={handleClick} href='#deleteplayers'>
              Deleting Players from Your Lineup
            </a>
          </li>
          <li>
            <a on:click={handleClick} href='#autopop'>
              Automatically Populating Teams in the Sort Order
            </a>
          </li>
          <li>
            <a on:click={handleClick} href='#autoabcd'>
              Automatically Populating ABC or ABCD Teams
            </a>
          </li>
          <li>
            <a on:click={handleClick} href='#manualpop'>
              Manually Populating Teams
            </a>
          </li>
          <li>
            <a on:click={handleClick} href='#choosetees'>
              Choosing Tees for Each Player
            </a>
          </li>
          <li>
            <a on:click={handleClick} href='#override'>
              Overriding a Player&apos;s GHIN Course Handicap or Taking a
              Player Out of the Game
            </a>
          </li>
          <li>
            <a on:click={handleClick} href='#setbets'>
              Setting Your Bets
            </a>
          </li>
          <li>
            <a on:click={handleClick} href='#save'>
              Saving a Lineup
            </a>
          </li>
          <li>
            <a on:click={handleClick} href='#retrieve'>
              Retrieving a Saved Lineup
            </a>
          </li>
          <li>
            <a on:click={handleClick} href='#clearteams'>
              Clearing All Team Assignmennts
            </a>
          </li>
          <li>
            <a on:click={handleClick} href='#moveteam'>
      ...
      <li>           
        <a on:click={handleClick} href='#exportlineup'>Exporting Your Lineup</a>
        <ul>
          <li>
            <a on:click={handleClick} href='#format'>Formatting Your Lineup</a>
          </li>
          <li>
            <a on:click={handleClick} href='#send'>Sending Your Lineup to Your Players</a></li>
        </ul>
      </li>
    </ul>
  </details>
